...
const wsApiOptions: WsApiOptionsColumn[] = [
  ...
  },
  {
    name: "openCallback",
    definition:
      "The callback function to handle the websocket connection being opened.",
    required: false,
  },
  {
    name: "closeCallback",
    definition:
      "The callback function to handle the websocket connection being closed.",
    required: false,
  },
  {
    name: "reconnect",
    definition:
      "(Defaults to true)  Whether to automatically reconnect if the connection is lost.",
    required: false,
  },
  {
    name: "reconnectDelay",
    definition:
      "(Defaults to 1000) The delay in milliseconds between reconnection attempts.",
    required: false,
  },
];
  ...
  return (
    <>
      <Section title="Connect">
        <p>
          To establish a connection to the websocket API, first create a WsApi
          instance, and then call its connect() method.
        </p>
      </Section>
      <Section title="Definition">
        <div className="grid gap-2">
          <p>The WsApi constructor is defined as follows:</p>
...
...
      ...
      <Section title="WebsocketErrorResponse">
        <p className="pb-6">
          It's a{" "}
          <Link to="#WebsocketResopnse" className="text-accent">
            WebsocketResponse
          </Link>{" "}
      ...
      <Section title="Usage">
        Refer to{" "}
        <Link
          to={"/typescript-client/websocket/quick-start"}
